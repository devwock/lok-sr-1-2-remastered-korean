...
| | |
| --- | --- |
| ![](docs/assets/screenshots/0.jpg) | ![](docs/assets/screenshots/1.jpg) |
| ![](docs/assets/screenshots/2.jpg) | ![](docs/assets/screenshots/3.jpg) |
| ![](docs/assets/screenshots/4.jpg) | ![](docs/assets/screenshots/5.jpg) |
| ![](docs/assets/screenshots/6.jpg) | ![](docs/assets/screenshots/7.jpg) |
...
| | |
| --- | --- |
| ![속성](docs/assets/install/0.png) | ![로컬 파일 경로](docs/assets/install/install_1.png) |

### 2. 파일 덮어쓰기

다운로드한 압축 파일을 열어 폴더를 기존 파일에 덮어씁니다.

![압축 파일을 게임 설치 경로에 덮어쓰는 방법](docs/assets/install/install_2.png)
...
| | |
| --- | --- |
| ![1편 언어 설정](docs/assets/install/install_3.jpg) | ![2편 언어 설정](docs/assets/install/install_4.jpg) |
...
| | |
| --- | --- |
| ![속성](docs/assets/install/0.png) | ![Steam에서 게임 파일 무결성을 확인하는 방법](docs/assets/install/uninstall_1.png) |
